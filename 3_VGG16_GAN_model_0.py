...
siim20_csv = pd.read_csv('./train3_0.csv',usecols=faeture_list)
...
gen_model.save('./model_path_VGG16/model_path0/vgg16_generator_model_192.h5')
disc_model.save('./model_path_VGG16/model_path0/vgg16_discriminator_model_192.h5')
gan_model.save('./model_path_VGG16/model_path0/vgg16_gan_model_192.h5')
...
img_gen_model = load_model('./model_path_VGG16/model_path0/vgg16_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
