...
siim20_csv = pd.read_csv('./train3_3.csv',usecols=faeture_list)
...
def add_gcs_path(image_id):
    ...
    #print(year_nb)
    GCS_PATH ='./trainn2_192/3/' + image_id 
...
def file_path(image_id):
    ...
    year_nb = filter_train.loc[filter_train.image_name == image_id].year.to_numpy()[0]
    #print(year_nb)
    GCS_PATH ='./trainn2_192/0/' + image_id 
...
train(gen_model, disc_model, gan_model, latent_dim, n_epochs=1, n_batch=BATCH_SIZE)
gen_model.save('./model_path_VGG16/model_path3/vgg16_generator_model_192.h5')
disc_model.save('./model_path_VGG16/model_path3/vgg16_discriminator_model_192.h5')
gan_model.save('./model_path_VGG16/model_path3/vgg16_gan_model_192.h5')
...
img_gen_model = load_model('./model_path_VGG16/model_path3/vgg16_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
