...
siim20_csv = pd.read_csv('./train3_1.csv',usecols=faeture_list)
...
def add_gcs_path(image_id):
    ...
    #print(year_nb)
    GCS_PATH ='./trainn2_192/1/' + image_id 
...
gen_model.save('./model_path_VGG19/model_path1/vgg19_generator_model_192.h5')
disc_model.save('./model_path_VGG19/model_path1/vgg19_discriminator2_model_192.h5')
gan_model.save('./model_path_VGG19/model_path1/vgg19_gan_model_192.h5')
...
img_gen_model = load_model('./model_path_VGG19/model_path1/vgg19_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
