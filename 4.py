...
image_path = "./VGG19_GAN_image_192/4/"
...
# load model
model = load_model('./model_path_VGG19/model_path4/vgg19_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
