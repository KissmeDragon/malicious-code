...
image_path = "./VGG19_GAN_image_192/2/"
...
# load model
model = load_model('./model_path_VGG19/model_path2/vgg19_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
#model = load_model('./model_path_VGG19/model_path0/vgg19_generator_model_192.h5')
# generate images
latent_points = generate_latent_points(4096, 450)
# generate images
