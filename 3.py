...
image_path = "./VGG19_GAN_image_192/3/"
...
# load model
model = load_model('./model_path_VGG19/model_path3/vgg19_generator_model_192.h5',compile=False, custom_objects={'LeakyReLU': tf.keras.layers.LeakyReLU()})
